...
public class Decomposition11 {
	...
	// Возвращает нулевое значение, если кол-во цифр в 'b' равно количеству цифр в 'a'
	...
	///////////////////////////////////////////////////////////
	// Формирует сообщение для печати резльтата в зависимости от значения параметра 'result'
